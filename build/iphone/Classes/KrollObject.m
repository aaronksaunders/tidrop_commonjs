...
//@interface testandroidmapObject : NSObject
//@end

@interface testandroidmapObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[testandroidmapObject class]])
		{
			for (NSString *key in [[(testandroidmapObject*)o modules] allKeys])
			{
