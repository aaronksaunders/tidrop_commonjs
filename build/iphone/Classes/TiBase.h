...
// in simulator we redefine to format for testandroidmap Developer console
...
{\
	NSString * exceptionName = [@"org.testandroidmap." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.testandroidmap";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UItestandroidmapNativeItemNone = -1, 
	UItestandroidmapNativeItemSpinner = -2,
	UItestandroidmapNativeItemProgressBar = -3,
	
	UItestandroidmapNativeItemSlider = -4,
	UItestandroidmapNativeItemSwitch = -5,
	UItestandroidmapNativeItemMultiButton = -6,
	UItestandroidmapNativeItemSegmented = -7,
	
	UItestandroidmapNativeItemTextView = -8,
	UItestandroidmapNativeItemTextField = -9,
	UItestandroidmapNativeItemSearchBar = -10,
	
	UItestandroidmapNativeItemPicker = -11,
	UItestandroidmapNativeItemDatePicker = -12,
	
	UItestandroidmapNativeItemInfoLight = -13,
	UItestandroidmapNativeItemInfoDark = -14,
	
	UItestandroidmapNativeItemDisclosure = -15,
	
	UItestandroidmapNativeItemContactAdd = -16
};
